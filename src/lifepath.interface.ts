import { IHomeland } from "./origins.interface"
...
export class Lifepath {
  constructor(
    public homeland :IHomeland,
    public familyFates :IFate[],
    public parentalFates :IFate[],
    public familyStatuses :IFamilyStatus[],
    public influentialFriends :IFriend[]
  ) {}
}
...
export const FamilyFates = {
  NorthernStatus: [
    ...
    { roll: 2, descriprion: "Your family was imprisoned for crimes or on trumped-upcharges. You were the only oneto escape. You may want to free them...or maybe not" },
